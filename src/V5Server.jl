...
pack(::Val{:get_team_info}, data) = pack(GetTeamInfoResult(team_info = data))

pack(::Val{:get_instruction}, data) = pack(GetInstructionResult(wheels = data))

pack(::Val{:get_placement}, data) = pack(GetPlacementResult(placement = data))
